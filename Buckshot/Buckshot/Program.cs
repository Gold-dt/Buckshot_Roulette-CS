...
namespace Buckshot
{
    ...
    {                       //1234567
        ...
        RoundShower roundShower = new RoundShower();
        ...
        public void MainGame(MainEngine game)
        {
            ...
            while (game.Round < MaxRound+1 && PlayerIsAlive == true)
            {
                ...
                while (game.LowestEnergy() != 0)
                {
                    ...
                    {
                        game.NewShells();
                        if(game.Round == 1 && used == false)
                        {
                            roundShower.RStarterDisplay(1, MaxRound, 0);
                            used = true;
                        }
                        NewShellShow();
                ...
                {
                    game.NextRound();
                    roundShower.RDisplay(game.Round,MaxRound,LastRound);
